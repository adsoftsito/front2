...
var /** @type {?} */ MINIMUM_COLUMN_WIDTH = 136;
export var /** @type {?} */ IgxGridTransaction = new InjectionToken('IgxGridTransaction');
/**
 * @record
 */
 ...
 * @abstract
 */
var IgxGridBaseComponent = /** @class */ (function () {
    function IgxGridBaseComponent(gridAPI, selection, _transactions, elementRef, zone, document, cdr, resolver, differs, viewRef, navigation, filteringService) {
        var _this = this;
    ...
    Object.defineProperty(IgxGridBaseComponent.prototype, "filteringExpressionsTree", {
        ...
        function (value) {
            if (value && value instanceof FilteringExpressionsTree) {
                ...
                for (var /** @type {?} */ index = 0; index < val.filteringOperands.length; index++) {
                    if (!(val.filteringOperands[index] instanceof FilteringExpressionsTree)) {
                        var /** @type {?} */ newExpressionsTree = new FilteringExpressionsTree(FilteringLogic.And, val.filteringOperands[index].fieldName);
                ...
                var /** @type {?} */ filteringExpressionTreeClone = new FilteringExpressionsTree(value.operator, value.fieldName);
    ...
    Object.defineProperty(IgxGridBaseComponent.prototype, "filteredData", {
        /**
    ...
    Object.defineProperty(IgxGridBaseComponent.prototype, "displayDensity", {
        get: /**
    ...
    Object.defineProperty(IgxGridBaseComponent.prototype, "rowList", {
        ...
        function () {
            ...
            var /** @type {?} */ rList = this._rowList.filter(function (item) {
    ...
    Object.defineProperty(IgxGridBaseComponent.prototype, "dataRowList", {
        ...
        function () {
            ...
            var /** @type {?} */ rList = this._dataRowList.filter(function (item) {
                return item.element.nativeElement.parentElement !== null;
            });
            res.reset(rList);
            return res;
    ...
    Object.defineProperty(IgxGridBaseComponent.prototype, "rowInEditMode", {
         ...
         */
        function () {
            var /** @type {?} */ editRowState = this.gridAPI.get_edit_row_state(this.id);
            return editRowState !== null ? this.rowList.find(function (e) { return e.rowID === editRowState.rowID; }) : null;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(IgxGridBaseComponent.prototype, "firstEditableColumnIndex", {
         ...
         */
        function () {
            var /** @type {?} */ index = tslib_1.__spread(this.pinnedColumns, this.unpinnedColumns).filter(function (e) { return !e.columnGroup; }).findIndex(function (e) { return e.editable; });
    ...
    Object.defineProperty(IgxGridBaseComponent.prototype, "lastEditableColumnIndex", {
         ...
         */
        function () {
            var /** @type {?} */ orderedColumns = tslib_1.__spread(this.pinnedColumns, this.unpinnedColumns).filter(function (e) { return !e.columnGroup; });
            var /** @type {?} */ index = orderedColumns.reverse().findIndex(function (e) { return e.editable; });
    ...
    Object.defineProperty(IgxGridBaseComponent.prototype, "shouldShowToolbar", {
        get: /**
         * @return {?}
         */
        function () {
    ...
    function (event) {
        var _this = this;
        var /** @type {?} */ scrollLeft = event.target.scrollLeft;
    ...
    function () {
        ...
        this.onRowAdded.pipe(takeUntil(this.destroy$)).subscribe(function () { return _this.refreshGridState(); });
        this.onRowDeleted.pipe(takeUntil(this.destroy$)).subscribe(function () { return _this.refreshGridState(); });
        this.onFilteringDone.pipe(takeUntil(this.destroy$)).subscribe(function () { return _this.refreshGridState(); });
        this.onCellEdit.pipe(takeUntil(this.destroy$)).subscribe(function (editCell) { return _this.clearSummaryCache(editCell); });
        this.onRowEdit.pipe(takeUntil(this.destroy$)).subscribe(function () { return _this.clearSummaryCache(); });
        this.onColumnMoving.pipe(takeUntil(this.destroy$)).subscribe(function () {
            _this.endEdit(true);
        });
        this.onColumnResized.pipe(takeUntil(this.destroy$)).subscribe(function () { return _this.endEdit(true); });
        this.onPagingDone.pipe(takeUntil(this.destroy$)).subscribe(function () { return _this.endEdit(true); });
        this.onSortingDone.pipe(takeUntil(this.destroy$)).subscribe(function () { return _this.endEdit(true); });
    ...
    function () {
        ...
        this.columnList.changes
            ...
            var /** @type {?} */ diff = _this.columnListDiffer.diff(change);
            if (diff) {
    ...
    function () {
        ...
        this.zone.runOutsideAngular(function () {
            ...
            _this.nativeElement.addEventListener('keydown', _this.keydownHandler.bind(_this));
        });
        ...
        if (!this.calcWidth && this._width !== undefined) {
            var /** @type {?} */ config = { childList: true, subtree: true };
            var /** @type {?} */ observer_1 = null;
            var /** @type {?} */ callback = function (mutationsList) {
                mutationsList.forEach(function (mutation) {
                    if (mutation.type === 'childList') {
                        var /** @type {?} */ addedNodes = new (Array.bind.apply(Array, tslib_1.__spread([void 0], mutation.addedNodes)))();
                        addedNodes.forEach(function (node) {
                            var /** @type {?} */ added = _this.checkIfGridIsAdded(node);
                            if (added) {
            ...
            observer_1 = new MutationObserver(callback);
            observer_1.observe(this.document.body, config);
        }
        this._dataRowList.changes.pipe(takeUntil(this.destroy$)).subscribe(function (list) {
            return _this._horizontalForOfs = list.toArray()
                .filter(function (item) { return item.element.nativeElement.parentElement !== null; })
                .map(function (row) { return row.virtDirRow; });
        });
        this.zone.runOutsideAngular(function () {
            return _this.verticalScrollContainer.getVerticalScroll().addEventListener('scroll', _this.verticalScrollHandler.bind(_this));
        });
        this.zone.runOutsideAngular(function () {
            return _this.parentVirtDir.getHorizontalScroll().addEventListener('scroll', _this.horizontalScrollHandler.bind(_this));
        });
        this._horizontalForOfs = this._dataRowList.map(function (row) { return row.virtDirRow; });
        var /** @type {?} */ vertScrDC = this.verticalScrollContainer.dc.instance._viewContainer.element.nativeElement;
    ...
    function () {
        ...
        this.zone.runOutsideAngular(function () {
            ...
            _this.verticalScrollContainer.getVerticalScroll().removeEventListener('scroll', _this.verticalScrollHandler);
            _this.parentVirtDir.getHorizontalScroll().removeEventListener('scroll', _this.horizontalScrollHandler);
            var /** @type {?} */ vertScrDC = _this.verticalScrollContainer.dc.instance._viewContainer.element.nativeElement;
     ...
     */
    function (args) {
        var /** @type {?} */ col = this.getColumnByName(args.column.field);
    ...
    Object.defineProperty(IgxGridBaseComponent.prototype, "calcResizerHeight", {
        /**
         * @hidden
         */
        get: /**
    ...
    Object.defineProperty(IgxGridBaseComponent.prototype, "unpinnedColumns", {
         ...
         */
        function () {
            return this._unpinnedColumns.filter(function (col) { return !col.hidden; }); // .sort((col1, col2) => col1.index - col2.index);
        },
        enumerable: true,
        configurable: true
    });
    ...
    function (rowIndex, columnField) {
        var /** @type {?} */ columnId = this.columnList.map(function (column) { return column.field; }).indexOf(columnField);
        if (columnId !== -1) {
    ...
    Object.defineProperty(IgxGridBaseComponent.prototype, "totalWidth", {
        ...
        function () {
            ...
            var /** @type {?} */ cols = this.visibleColumns.filter(function (col) { return col.level === 0 && !col.pinned; });
    ...
    function (from, to, pos) {
        var /** @type {?} */ list = this.columnList.toArray();
        var /** @type {?} */ fromIndex = list.indexOf(from);
        var /** @type {?} */ toIndex = list.indexOf(to);
        ...
        var /** @type {?} */ activeColumn = null;
        var /** @type {?} */ activeColumnIndex = -1;
        ...
        var /** @type {?} */ newList = this._resetColumnList(list);
        this.columnList.reset(newList);
        this.columnList.notifyOnChanges();
        this._columns = this.columnList.toArray();
        if (activeColumn !== null && activeColumn !== undefined) {
            var /** @type {?} */ newIndex = newList.indexOf(activeColumn);
    ...
    function (from, to, position) {
        var /** @type {?} */ pinned = this._pinnedColumns;
        var /** @type {?} */ dropIndex = pinned.indexOf(to);
    ...
    function (parent, from, to, pos) {
        var /** @type {?} */ buffer = parent.children.toArray();
        var /** @type {?} */ fromIndex = buffer.indexOf(from);
        var /** @type {?} */ toIndex = buffer.indexOf(to);
        if (pos === DropPosition.BeforeDropTarget) {
            toIndex--;
        }
        if (pos === DropPosition.AfterDropTarget) {
    ...
    function (column, dropTarget, pos) {
        ...
        var /** @type {?} */ position = pos;
        var /** @type {?} */ fromIndex = column.visibleIndex;
        var /** @type {?} */ toIndex = dropTarget.visibleIndex;
        ...
        if (!dropTarget.pinned && column.pinned) {
            column.unpin();
            var /** @type {?} */ list = this.columnList.toArray();
            var /** @type {?} */ fi = list.indexOf(column);
            var /** @type {?} */ ti = list.indexOf(dropTarget);
    ...
    function (data, parentID) {
        ...
        if (this.transactions.enabled) {
            var /** @type {?} */ transactionId = this.primaryKey ? data[this.primaryKey] : data;
            var /** @type {?} */ transaction = { id: transactionId, type: TransactionType.ADD, newValue: data };
    ...
    function (rowId) {
        var _this = this;
        var /** @type {?} */ index;
        var /** @type {?} */ data = this.gridAPI.get_all_data(this.id);
        if (this.primaryKey) {
            index = data.map(function (record) { return record[_this.primaryKey]; }).indexOf(rowId);
        }
        else {
            index = data.indexOf(rowId);
        }
        var /** @type {?} */ state = this.transactions.getState(rowId);
        var /** @type {?} */ hasRowInNonDeletedState = state && state.type !== TransactionType.DELETE;
        //  if there is a row (index !== -1) and the we have cell in edit mode on same row exit edit mode
        //  if there is no row (index === -1), but there is a row in ADD or UPDATE state do as above
        //  Otherwise just exit - there is nothing to delete
        if (index !== -1 || hasRowInNonDeletedState) {
            var /** @type {?} */ editableCell = this.gridAPI.get_cell_inEditMode(this.id);
    ...
    function (rowID, index) {
        ...
        if (index !== -1) {
            if (this.transactions.enabled) {
                var /** @type {?} */ transaction = { id: rowID, type: TransactionType.DELETE, newValue: null };
    ...
    function (value, rowSelector, column) {
        if (this.primaryKey !== undefined && this.primaryKey !== null) {
            var /** @type {?} */ columnEdit = this.columnList.toArray().filter(function (col) { return col.field === column; });
            if (columnEdit.length > 0) {
                var /** @type {?} */ columnId = this.columnList.toArray().indexOf(columnEdit[0]);
                var /** @type {?} */ editableCell = this.gridAPI.get_cell_inEditMode(this.id);
                var /** @type {?} */ gridEditState = this.gridAPI.create_grid_edit_args(this.id, rowSelector, columnId, value);
    ...
    function (name, value, conditionOrExpressionTree, ignoreCase) {
        var /** @type {?} */ col = this.gridAPI.get_column_by_name(this.id, name);
        var /** @type {?} */ filteringIgnoreCase = ignoreCase || (col ? col.filteringIgnoreCase : false);
        if (conditionOrExpressionTree) {
            this.gridAPI.filter(this.id, name, value, conditionOrExpressionTree, filteringIgnoreCase);
        }
        else {
            var /** @type {?} */ expressionsTreeForColumn = this._filteringExpressionsTree.find(name);
            if (expressionsTreeForColumn instanceof FilteringExpressionsTree) {
                ...
                var /** @type {?} */ expressionForColumn = /** @type {?} */ (expressionsTreeForColumn);
    ...
    function (name) {
        if (name) {
            var /** @type {?} */ column = this.gridAPI.get_column_by_name(this.id, name);
            if (!column) {
                return;
            }
        }
    ...
    function (columnName, index) {
        var /** @type {?} */ col = columnName instanceof IgxColumnComponent ? columnName : this.getColumnByName(columnName);
    ...
    function () {
        var _this = this;
        this.summariesHeight = 0;
        requestAnimationFrame(function () { return _this.calculateGridSizes(); });
    };
    /**
    ...
    function (updateActiveInfo) {
        ...
        if (this.lastSearchInfo.searchText) {
            ...
            if (updateActiveInfo) {
                var /** @type {?} */ activeInfo_1 = IgxTextHighlightDirective.highlightGroupsMap.get(this.id);
    ...
    Object.defineProperty(IgxGridBaseComponent.prototype, "hasSummarizedColumns", {
         ...
         */
        function () {
            var /** @type {?} */ summarizedColumns = this.columnList.filter(function (col) { return col.hasSummary; });
            return summarizedColumns.length > 0 && summarizedColumns.some(function (col) { return !col.hidden; });
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(IgxGridBaseComponent.prototype, "hasColumnGroups", {
         ...
         */
        function () {
            return this.columnList.some(function (col) { return col.columnGroup; });
        },
        enumerable: true,
        configurable: true
    });
    ...
    function () {
        ...
        if (!this.nativeElement.parentNode.clientHeight) {
            var /** @type {?} */ viewPortHeight = document.documentElement.clientHeight;
            this._height = this.rowBasedHeight <= viewPortHeight ? null : viewPortHeight.toString();
        }
        else {
            var /** @type {?} */ parentHeight = this.nativeElement.parentNode.getBoundingClientRect().height;
    ...
    Object.defineProperty(IgxGridBaseComponent.prototype, "defaultTargetBodyHeight", {
         ...
         */
        function () {
            var /** @type {?} */ allItems = this.totalItemCount || this.dataLength;
     ...
     */
    function () {
        var /** @type {?} */ computed = this.document.defaultView.getComputedStyle(this.nativeElement);
        ...
        var /** @type {?} */ toolbarHeight = 0;
        if (this.showToolbar && this.toolbarHtml != null) {
            toolbarHeight = this.toolbarHtml.nativeElement.firstElementChild ?
                this.toolbarHtml.nativeElement.offsetHeight : 0;
        }
        var /** @type {?} */ pagingHeight = 0;
        ...
        var /** @type {?} */ groupAreaHeight = this.getGroupAreaHeight();
     ...
     * @return {?}
     */
    function (gridHeight, toolbarHeight, pagingHeight, groupAreaHeight) {
        var /** @type {?} */ footerBordersAndScrollbars = this.tfoot.nativeElement.offsetHeight -
            this.tfoot.nativeElement.clientHeight;
        if (isNaN(gridHeight)) {
     ...
     */
    function () {
        var /** @type {?} */ computedWidth = parseInt(this.document.defaultView.getComputedStyle(this.nativeElement).getPropertyValue('width'), 10);
        if (this.rowSelectable) {
            computedWidth -= this.headerCheckboxContainer.nativeElement.clientWidth;
        }
        var /** @type {?} */ visibleChildColumns = this.visibleColumns.filter(function (c) { return !c.columnGroup; });
        var /** @type {?} */ columnsWithSetWidths = visibleChildColumns.filter(function (c) { return c.widthSetByUser; });
        var /** @type {?} */ columnsToSize = visibleChildColumns.length - columnsWithSetWidths.length;
        var /** @type {?} */ sumExistingWidths = columnsWithSetWidths
            .reduce(function (prev, curr) { return prev + parseInt(curr.width, 10); }, 0);
        var /** @type {?} */ columnWidth = !Number.isFinite(sumExistingWidths) ?
    ...
    function () {
        ...
        if (this._width && this._width.indexOf('%') !== -1) {
            /* width in %*/
            var /** @type {?} */ width = parseInt(computed.getPropertyValue('width'), 10);
     ...
     * @return {?}
     */
    IgxGridBaseComponent.prototype.calcMaxSummaryHeight = /**
     * @hidden
     * @return {?}
     */
    function () {
        var _this = this;
        var /** @type {?} */ maxSummaryLength = 0;
        this.columnList.filter(function (col) { return col.hasSummary && !col.hidden; }).forEach(function (column) {
            _this.gridAPI.set_summary_by_column_name(_this.id, column.field);
            var /** @type {?} */ getCurrentSummaryColumn = _this.gridAPI.get_summaries(_this.id).get(column.field);
    ...
    function (takeHidden) {
        ...
        var /** @type {?} */ fc = takeHidden ? this._pinnedColumns : this.pinnedColumns;
        var /** @type {?} */ sum = 0;
        try {
    ...
    function (takeHidden) {
        if (takeHidden === void 0) { takeHidden = false; }
        var /** @type {?} */ width = this._width && this._width.indexOf('%') !== -1 ?
            this.calcWidth :
     ...
     * @return {?}
     */
    IgxGridBaseComponent.prototype._sort = /**
     * @hidden
     * @param {?} expression
     * @return {?}
     */
     ...
     * @return {?}
     */
    IgxGridBaseComponent.prototype._sortMultiple = /**
     * @hidden
     * @param {?} expressions
     * @return {?}
     */
    ...
    function (fieldName, hasSummary, summaryOperand) {
        var /** @type {?} */ column = this.gridAPI.get_column_by_name(this.id, fieldName);
    ...
    function () {
        var _this = this;
        var /** @type {?} */ factory = this.resolver.resolveComponentFactory(IgxColumnComponent);
        var /** @type {?} */ fields = Object.keys(this.data[0]);
        var /** @type {?} */ columns = [];
        fields.forEach(function (field) {
            var /** @type {?} */ ref = _this.viewRef.createComponent(factory, null, _this.viewRef.injector);
    ...
    Object.defineProperty(IgxGridBaseComponent.prototype, "template", {
        get: /**
         * @return {?}
         */
        function () {
    ...
    function (headerStatus) {
        if (headerStatus === undefined) {
            var /** @type {?} */ dataLength = this.filteredData ? this.filteredData.length : this.dataLength;
    ...
    function (componentID, filteredData, primaryKey) {
        var /** @type {?} */ currSelection = this.selection.get(componentID);
        var /** @type {?} */ atLeastOneSelected = false;
        var /** @type {?} */ notAllSelected = false;
        if (currSelection) {
            try {
                for (var _a = tslib_1.__values(Object.keys(filteredData)), _b = _a.next(); !_b.done; _b = _a.next()) {
                    var key = _b.value;
                    var /** @type {?} */ dataItem = primaryKey ? filteredData[key][primaryKey] : filteredData[key];
    ...
    function (newSelectionAsSet, row, event, headerStatus) {
        var /** @type {?} */ oldSelectionAsSet = this.selection.get(this.id);
        var /** @type {?} */ oldSelection = oldSelectionAsSet ? Array.from(oldSelectionAsSet) : [];
        var /** @type {?} */ newSelection = newSelectionAsSet ? Array.from(newSelectionAsSet) : [];
        var /** @type {?} */ args = { oldSelection: oldSelection, newSelection: newSelection, row: row, event: event };
    ...
    function (text, increment, caseSensitive, exactMatch, scroll) {
        ...
        var /** @type {?} */ editModeCell = this.gridAPI.get_cell_inEditMode(this.id);
        if (editModeCell) {
            this.endEdit(false);
        }
        ...
        if (this.lastSearchInfo.matchInfoCache.length) {
            var /** @type {?} */ matchInfo = this.lastSearchInfo.matchInfoCache[this.lastSearchInfo.activeMatchIndex];
     ...
     * @return {?}
     */
    IgxGridBaseComponent.prototype.resolveFilteredSortedData = /**
     * @hidden
     * @return {?}
     */
    function () {
        var /** @type {?} */ data = this.filteredData ? this.filteredData : this.data;
     ...
     */
    function () {
        var /** @type {?} */ currentPinnedWidth = 0;
        var /** @type {?} */ pinnedColumns = [];
        var /** @type {?} */ unpinnedColumns = [];
        var /** @type {?} */ newUnpinnedCols = [];
        ...
        for (var /** @type {?} */ i = 0; i < this._columns.length; i++) {
            if (this._columns[i].pinned && !this._columns[i].parent) {
                // Pinned column. Check if with it the unpinned min width is exceeded.
                var /** @type {?} */ colWidth = parseInt(this._columns[i].width, 10);
    ...
    function (row, column, page, groupByRecord) {
        ...
        var /** @type {?} */ scrollRow = this.rowList.find(function (r) { return r.virtDirRow; });
        var /** @type {?} */ virtDir = scrollRow ? scrollRow.virtDirRow : null;
    ...
    function () {
        ...
        var /** @type {?} */ caseSensitive = this.lastSearchInfo.caseSensitive;
        var /** @type {?} */ exactMatch = this.lastSearchInfo.exactMatch;
        var /** @type {?} */ searchText = caseSensitive ? this.lastSearchInfo.searchText : this.lastSearchInfo.searchText.toLowerCase();
        var /** @type {?} */ data = this.filteredSortedData;
        var /** @type {?} */ columnItems = this.visibleColumns.filter(function (c) { return !c.columnGroup; }).sort(function (c1, c2) { return c1.visibleIndex - c2.visibleIndex; });
        var /** @type {?} */ groupIndexData = this.getGroupIncrementData();
        var /** @type {?} */ groupByRecords = this.getGroupByRecords();
        var /** @type {?} */ collapsedRowsCount = 0;
        data.forEach(function (dataRow, i) {
            var /** @type {?} */ groupByRecord = groupByRecords ? groupByRecords[i] : null;
            var /** @type {?} */ groupByIncrement = groupIndexData ? groupIndexData[i] : 0;
            var /** @type {?} */ pagingIncrement = _this.getPagingIncrement(groupByIncrement, groupIndexData, Math.floor(i / _this.perPage));
            var /** @type {?} */ rowIndex = _this.paging ? (i % _this.perPage) + pagingIncrement : i + groupByIncrement;
            if (_this.paging && i % _this.perPage === 0) {
                collapsedRowsCount = 0;
            }
            rowIndex -= collapsedRowsCount;
            if (groupByRecord && !_this.isExpandedGroup(groupByRecord)) {
                collapsedRowsCount++;
            }
            columnItems.forEach(function (c, j) {
                var /** @type {?} */ value = c.formatter ? c.formatter(dataRow[c.field]) : dataRow[c.field];
                if (value !== undefined && value !== null && c.searchable) {
                    var /** @type {?} */ searchValue = caseSensitive ? String(value) : String(value).toLowerCase();
                    var /** @type {?} */ pageIndex = _this.paging ? Math.floor(i / _this.perPage) : 0;
                    if (exactMatch) {
                        ...
                        var /** @type {?} */ occurenceIndex = 0;
                        var /** @type {?} */ searchIndex = searchValue.indexOf(searchText);
                        while (searchIndex !== -1) {
                            _this.lastSearchInfo.matchInfoCache.push({
                                row: rowIndex,
                                column: j,
    ...
    */
     ...
     * @return {?}
     */
    IgxGridBaseComponent.prototype.getPagingIncrement = /**
     * @param {?} groupByIncrement
     * @param {?} groupIndexData
     * @param {?} page
     * @return {?}
     */
    function (groupByIncrement, groupIndexData, page) {
        var /** @type {?} */ pagingIncrement = 0;
        if (this.paging && groupByIncrement) {
            var /** @type {?} */ lastRowOnPrevPageInrement = page ? groupIndexData[page * this.perPage - 1] : 0;
            var /** @type {?} */ firstRowOnThisPageInrement = groupIndexData[page * this.perPage];
            ...
            var /** @type {?} */ additionalPagingIncrement = lastRowOnPrevPageInrement === firstRowOnThisPageInrement ? 1 : 0;
     ...
     * @return {?}
     */
    IgxGridBaseComponent.prototype.restoreHighlight = /**
     * @hidden
     * @return {?}
     */
    function () {
        var _this = this;
        if (this.lastSearchInfo.searchText) {
            var /** @type {?} */ activeInfo_2 = IgxTextHighlightDirective.highlightGroupsMap.get(this.id);
            var /** @type {?} */ matchInfo = this.lastSearchInfo.matchInfoCache[this.lastSearchInfo.activeMatchIndex];
            var /** @type {?} */ data = this.filteredSortedData;
            var /** @type {?} */ groupByIncrements = this.getGroupIncrementData();
            var /** @type {?} */ rowIndex = matchInfo ? data.indexOf(matchInfo.item) : -1;
            var /** @type {?} */ page_1 = this.paging ? Math.floor(rowIndex / this.perPage) : 0;
            var /** @type {?} */ increment = groupByIncrements && rowIndex !== -1 ? groupByIncrements[rowIndex] : 0;
            if (this.paging && increment) {
                increment = this.getPagingIncrement(increment, groupByIncrements, page_1);
            }
            var /** @type {?} */ row_1 = this.paging ? (rowIndex % this.perPage) + increment : rowIndex + increment;
            this.rebuildMatchCache();
            if (rowIndex !== -1) {
                if (this.collapsedHighlightedItem && groupByIncrements !== null) {
                    this.collapsedHighlightedItem.info.page = page_1;
                    this.collapsedHighlightedItem.info.rowIndex = row_1;
                }
                else {
                    IgxTextHighlightDirective.setActiveHighlight(this.id, {
                        columnIndex: activeInfo_2.columnIndex,
                        rowIndex: row_1,
                        index: activeInfo_2.index,
                        page: page_1
                    });
                    this.lastSearchInfo.matchInfoCache.forEach(function (match, i) {
                        if (match.column === activeInfo_2.columnIndex &&
                            match.row === row_1 &&
                            match.index === activeInfo_2.index &&
                            match.page === page_1) {
                            _this.lastSearchInfo.activeMatchIndex = i;
                        }
                    });
    ...
    */
     ...
     * @return {?}
     */
    IgxGridBaseComponent.prototype.getGroupIncrementData = /**
     * @hidden
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    IgxGridBaseComponent.prototype.checkIfGridIsAdded = /**
     * @param {?} node
     * @return {?}
     */
    function (node) {
        if (node === this.nativeElement) {
            ...
            try {
                for (var _a = tslib_1.__values(node.childNodes), _b = _a.next(); !_b.done; _b = _a.next()) {
                    var childNode = _b.value;
                    var /** @type {?} */ added = this.checkIfGridIsAdded(childNode);
                    if (added) {
                        return true;
                    }
                }
     ...
     * @return {?}
     */
    IgxGridBaseComponent.prototype.notGroups = /**
     * @hidden
     * @param {?} arr
     * @return {?}
     */
     ...
     * @return {?}
     */
    IgxGridBaseComponent.prototype.startRowEdit = /**
     * @hidden
     * @param {?} cell
     * @return {?}
     */
    function (cell) {
        ...
        var /** @type {?} */ rowState = { rowID: cell.rowID, rowIndex: cell.rowIndex };
     ...
     */
    function (show) {
        var /** @type {?} */ rowStyle = this.rowEditingOverlay.element.style;
        if (show) {
    ...
    function (row) {
        if (!this.rowEditingOverlay.collapsed) {
            var /** @type {?} */ rowStyle = this.rowEditingOverlay.element.parentElement.style;
            if (row) {
                rowStyle.display = '';
    ...
    function (rowID) {
        ...
        var /** @type {?} */ targetRow = this.gridAPI.get_row_by_key(this.id, rowID);
        if (!targetRow) {
            return;
        }
    ...
    Object.defineProperty(IgxGridBaseComponent.prototype, "rowChangesCount", {
        ...
        function () {
            ...
            var /** @type {?} */ rowChanges = this.transactions.getAggregatedValue(this.rowInEditMode.rowID, false);
     ...
     * @return {?}
     */
    function (commit, rowID, rowObject) {
        var /** @type {?} */ valueInTransactions = this.transactions.getAggregatedValue(rowID, true);
        var /** @type {?} */ rowIndex = this.gridAPI.get_row_index_in_data(this.id, rowID); // Get actual index in data
        var /** @type {?} */ newValue = valueInTransactions ? valueInTransactions : this.gridAPI.get_all_data(this.id)[rowIndex];
        var /** @type {?} */ oldValue = Object.assign({}, this.gridAPI.get_all_data(this.id)[rowIndex], this._currentRowState);
        // if (this.transactions.enabled) {
        ...
        // }
        var /** @type {?} */ currentGridState = this.gridAPI.create_grid_edit_args(this.id, rowID, null, newValue);
    ...
    function (commit, event) {
        ...
        var /** @type {?} */ row = this.gridAPI.get_edit_row_state(this.id);
        var /** @type {?} */ cell = this.gridAPI.get_cell_inEditMode(this.id);
        var /** @type {?} */ rowObj = row ? this.getRowByKey(row.rowID) : null;
        if (commit) {
            this.gridAPI.submit_value(this.id);
        }
        else {
        ...
        var /** @type {?} */ currentCell = (row && cell) ? this.gridAPI.get_cell_by_index(this.id, row.rowIndex, cell.cellID.columnID) : null;
    ...
    Object.defineProperty(IgxGridBaseComponent.prototype, "dataWithAddedInTransactionRows", {
         ...
         */
        function () {
            var /** @type {?} */ result = /** @type {?} */ (cloneArray(this.gridAPI.get_all_data(this.id)));
            if (this.transactions.enabled) {
...
//# sourceMappingURL=data:application/json;base64,