export declare enum FeatureOutputType {
...
export declare class GridHelper {
     ...
     */
    constructor();
    generateFeatures(gridFeatures: string[], pad?: number): string;
    addFeature(name: any, overrideOptions?: any): void;
    updateFeature(name: any, overrideOptions: any): void;
    /**
     * Returns and object like `{name: "feature"}` with any other default properties
     * @param name Feature name
     */
    private getFeature(name);
    private generateXML(pad);
}
