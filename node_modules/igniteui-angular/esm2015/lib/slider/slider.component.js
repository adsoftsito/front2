...
export class IgxSliderComponent {
     ...
     */
    get isRange() {
        const /** @type {?} */ isRange = this.type === SliderType.RANGE;
        return isRange;
    }
    /**
    ...
    get value() {
        if (this.isRange) {
            ...
            const /** @type {?} */ val = this.snapValueToStep(this.upperValue);
            return val;
        }
    }
    /**
    ...
    onKeyDown($event) {
        ...
        if (this.isRange) {
            if (this.activeHandle === SliderHandle.FROM) {
                const /** @type {?} */ newLower = (/** @type {?} */ (this.value)).lower + incrementSign * this.step;
                ...
                const /** @type {?} */ newUpper = (/** @type {?} */ (this.value)).upper + incrementSign * this.step;
    ...
    invalidateValue() {
        if (!this.isRange) {
            ...
            const /** @type {?} */ value = /** @type {?} */ (this.value);
     ...
     */
    closestHandle() {
        const /** @type {?} */ fromOffset = this.thumbFrom.nativeElement.offsetLeft + this.thumbFrom.nativeElement.offsetWidth / 2;
        const /** @type {?} */ toOffset = this.thumbTo.nativeElement.offsetLeft + this.thumbTo.nativeElement.offsetWidth / 2;
        const /** @type {?} */ match = this.closestTo(this.xPointer, [fromOffset, toOffset]);
        if (match === toOffset) {
            this.thumbTo.nativeElement.focus();
        }
    ...
    setTickInterval() {
        ...
        const /** @type {?} */ interval = this.step > 1 ? this.step : null;
    ...
    snapValueToStep(value) {
        const /** @type {?} */ valueModStep = (value - this.minValue) % this.step;
        let /** @type {?} */ snapValue = value - valueModStep;
     ...
     */
    setSliderOffset() {
        const /** @type {?} */ rect = this.slider.nativeElement.getBoundingClientRect();
    ...
    fractionToValue(fraction) {
        const /** @type {?} */ max = this.maxValue;
        const /** @type {?} */ min = this.minValue;
     ...
     */
    updateTrack() {
        const /** @type {?} */ fromPosition = this.valueToFraction(this.lowerValue);
        const /** @type {?} */ toPosition = this.valueToFraction(this.upperValue);
        const /** @type {?} */ positionGap = (this.valueToFraction(this.upperValue) - this.valueToFraction(this.lowerValue));
        if (!this.isRange) {
    ...
    hasValueChanged(oldValue) {
        const /** @type {?} */ isSliderWithDifferentValue = !this.isRange && oldValue !== this.value;
        const /** @type {?} */ isRangeWithOneDifferentValue = this.isRange &&
