/**
 * A function which returns the abbreviated name of the timezone.
 *
 * You can specify an optional date for returning the timezone name at a different point in time.
 * The corresponding UTC date is used for locating the relevant rule.
 *
 * Timezone names change both historically and when they reflect the Daylight Savings Time rules.
 *
