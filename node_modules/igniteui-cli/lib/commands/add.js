...
command = {
    ...
    execute(argv) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (selectedTemplate) {
                ...
                yield command.addTemplate(argv.name, selectedTemplate, argv.module);
    ...
    addTemplate(name, template, modulePath) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (yield template.generateFiles(process.cwd(), name, { modulePath })) {
                //successful
