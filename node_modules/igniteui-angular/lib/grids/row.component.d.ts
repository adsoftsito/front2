...
export declare class IgxRowComponent<T extends IgxGridBaseComponent> implements DoCheck {
    ...
    constructor(gridAPI: GridBaseAPIService<T>, selection: IgxSelectionAPIService, element: ElementRef, cdr: ChangeDetectorRef);
    /**
     * @hidden
     */
