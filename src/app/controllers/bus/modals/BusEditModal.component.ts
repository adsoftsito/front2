...
export class NgbdModalEditBus{ 
    ...
    myForm: FormGroup;
    public currentBus: any[] = [undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined];
    ...
    constructor(
        ...
        addCompany(newCompany){
            ...
            this.service.addCompany(newCompany[0], newCompany[1], newCompany[2], newCompany[3], newCompany[4], newCompany[5], newCompany[6], newCompany[7])
            .subscribe(res => {
