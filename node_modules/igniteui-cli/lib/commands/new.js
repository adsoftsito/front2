    ...
    execute(argv) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (projTemplate == null) {
                return Util_1.Util.error("Default project template not found");
            }
            ...
            Util_1.Util.log("  ig start starts the project");
            Util_1.Util.log("  ig add [template] [name] adds template by its ID");
        });
    }
};
