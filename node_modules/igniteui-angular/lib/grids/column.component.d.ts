...
export declare class IgxColumnComponent implements AfterContentInit {
     ...
     *@hidden
     */
    protected _sortStrategy: SortingStrategy;
    /**
     *@hidden
     */
    ...
    static updateHighlights(oldIndex: number, newIndex: number, grid: IgxGridBaseComponent): void;
    constructor(gridAPI: GridBaseAPIService<IgxGridBaseComponent>, cdr: ChangeDetectorRef);
    /**
     *@hidden
     */
