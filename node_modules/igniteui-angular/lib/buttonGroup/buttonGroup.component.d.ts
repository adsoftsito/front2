import { AfterViewInit, ChangeDetectorRef, EventEmitter, Renderer2, OnDestroy } from '@angular/core';
 ...
 * ```
 */
export declare class IgxButtonGroupComponent implements AfterViewInit, OnDestroy {
    private _cdr;
    private _renderer;
    private _disabled;
