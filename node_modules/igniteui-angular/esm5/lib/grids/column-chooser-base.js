...
var ColumnChooserBase = /** @class */ (function () {
    ...
    function () {
        try {
            for (var _a = tslib_1.__values(this._currentColumns), _b = _a.next(); !_b.done; _b = _a.next()) {
                var item = _b.value;
    ...
    function () {
        ...
        if (this._gridColumns.length > 0) {
            ...
            this._gridColumns.forEach(function (column) {
                var /** @type {?} */ item = _this.createColumnItem(_this, column);
                if (item) {
     ...
     */
    function () {
        var /** @type {?} */ filteringExpressionsTree = new FilteringExpressionsTree(FilteringLogic.Or);
        ...
        var /** @type {?} */ strategy = new CustomFilteringStrategy();
